...
Brief description of the dataset is available in [[file:/media/michak/DataDrive/porfolio_github/Empirical_Mode_Decomposition_Neuroinformatics/data/BCICompetitionIII/IIIb/desc_IIIb.pdf][data description]] file. Read it know to familiarize with the experiment context and terminology used further.
...
Dataset we are using here is almost the same. It is described in the website: http://www.bbci.de/competition/iii/#data_set_iiib . This data is no longer sended after submitting download form, however I know somebody that had downloaded it - data with description is available in [[file:/media/michak/DataDrive/porfolio_github/Empirical_Mode_Decomposition_Neuroinformatics/data/BCICompetitionIII.zip][the archive]].
--------
